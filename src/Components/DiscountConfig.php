 ...
 * Combines rate type toggle (percent/fixed), amount input with dynamic
 * unit display, currency selector, and duration controls.
 *
	...
	public function render(): string {
		...
		<div class="wp-flyout-field">
			...
			<div class="<?php echo esc_attr( $classes ); ?>"
				...
				<?php // ---- Rate Type Toggle ---- ?>
				<div class="discount-config-type">
					<?php foreach ( self::RATE_TYPES as $value => $label ) : ?>
						<label class="discount-config-type-option <?php echo $rate_type === $value ? 'is-active' : ''; ?>">
							<input type="radio"
